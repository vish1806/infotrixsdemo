const UserApi = {
  ...
  getBorrowBook: async () => {
    const res = await fetch("http://localhost:8080/v1/user/borrowed-books", { method: "GET" });
  ...
  getProfile: async () => {
    const res = await fetch("http://localhost:8080/v1/user/profile", { method: "GET" });
    return res.json();
  },
  logout: async () => {
    const res = await fetch("http://localhost:8080/v1/user/logout", { method: "GET" });
    return res.json();
  },
};
